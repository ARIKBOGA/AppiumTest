...
public class FirstTest {
    ...
    @DisplayName("First Appium Test Practice")
    @Test
    public void test1() throws MalformedURLException {
        ...
        MobileElement parenthesis = driver.findElement(MobileBy.AccessibilityId("left or right parenthesis"));
        System.out.println("parenthesis.getText() = " + parenthesis.getText());

        Assertions.assertTrue(parenthesis.isEnabled());
